...
| `cursor-readme-sync.mdc` | When editing under `.cursor/**`, keep this README accurate. **Applies to** `.cursor/**`. |
...
| `agents-updater` | After Taskfile, templates, rules, or agent cross-references change—reconcile agent text and **this README**. |
